function(import_libxc)
  ...
  set(DISABLE_FHC ON CACHE BOOL "Libxc: Disable enforcement of Fermi hole curvature")
  set(DISABLE_FXC ON CACHE BOOL "Libxc: Don't compile second derivative code")
  set(DISABLE_KXC ON CACHE BOOL "Libxc: Don't compile third derivative code")
  ...
  #install(TARGETS xc EXPORT _core DESTINATION lib)
